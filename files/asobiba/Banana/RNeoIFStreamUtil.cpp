// RNeoIFStreamUtil.cpp: RNeoIFStreamUtil クラスのインプリメンテーション
//
//////////////////////////////////////////////////////////////////////
...
int RNeoIFStreamUtil::Read(char *outBuffer ,int inBufferSize,RNeoIFStreamUtilChecker* inStreamChecker) throw(RException)
{
...
void RNeoIFStreamUtil::test()
{
	{
		RNeoFile file;
		file.Open("test/rstreamtest.txt" , "rb");
		RNeoIFStreamUtilForReturnCode returnCheck;
		
		char buffer[4];

		RNeoIFStreamUtil stream;
