// RfileLocalReport.cpp: RfileLocalReport クラスのインプリメンテーション
//
//////////////////////////////////////////////////////////////////////
...
//登録します。
void RfileLocalReport::Attach(const Rfiles* inRfiles ,const char* inName,__int64 inSize,__int64 inDate,DWORD inAttrib)
{
	this->Name = inName;
	this->Size = inSize;
	this->Date = inDate;
...
//値の取得.
const string RfileLocalReport::getVars(__FILECOLUMN_TYPE inType) const
{
	switch(inType)
	{
...
//イメージの取得.
const int RfileLocalReport::getImageIndex() const
{
...
//特殊なファイル修飾子の取得.
FileModifyData* RfileLocalReport::NormalLoadModifty(string inExt , string inFullFilename )
{
...
//特殊なファイル修飾子の取得.
FileModifyData* RfileLocalReport::SpecialLoadModifty(string inExt , string inFullFilename ,
...
//ディレクトリのファイル修飾子の取得.
FileModifyData* RfileLocalReport::DirectoryLoadModifty(string inFullFilename )
{
	FileModifyChacheLargeWin32* fmc = FileModifyChacheLargeWin32::getInstance();
